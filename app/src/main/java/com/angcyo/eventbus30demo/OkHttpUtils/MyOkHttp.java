package com.angcyo.eventbus30demo.OkHttpUtils;

import android.content.Context;
import android.os.Handler;
import android.os.Looper;

import com.angcyo.eventbus30demo.OkHttpUtils.body.ProgressRequestBody;
import com.angcyo.eventbus30demo.OkHttpUtils.body.ResponseProgressBody;
import com.angcyo.eventbus30demo.OkHttpUtils.response.DownloadResponseHandler;
import com.angcyo.eventbus30demo.OkHttpUtils.response.GsonResponseHandler;
import com.angcyo.eventbus30demo.OkHttpUtils.response.IResponseHandler;
import com.angcyo.eventbus30demo.OkHttpUtils.response.JsonResponseHandler;
import com.angcyo.eventbus30demo.OkHttpUtils.response.RawResponseHandler;
...
public class MyOkHttp {
    ...
    public MyOkHttp() {
          ...
          //日志拦截器
          HttpLoggingInterceptor mLogIntercepter= new HttpLoggingInterceptor();
          mLogIntercepter.setLevel(HttpLoggingInterceptor.Level.BODY);
        ...
        client = new OkHttpClient.Builder()
                ...
                .addInterceptor(mLogIntercepter)//日志拦截器
